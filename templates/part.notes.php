<?php // Add new note ?>
<button id="new_note_button">New</button>
<article id="note_template" class="note">
	<div class="content"></div>
	<footer><span class="meta"></span><button class="edit">Edit</button><button class="trash">Trash</button></footer>
</article>
...
<?php // Load all 'current' notes 
	...
	foreach ($notes as $note) { ?>
		<article id="note_id_<?php p($note['note_id']); ?>" class="note">
			...
			<footer>
				...
				<button class="trash_button">Trash</button>
			</footer>
		</article>
	...
	if ($trashed_notes) {
		print_unescaped("<button id='show_trash'>Show Trash</button>"); ?>
